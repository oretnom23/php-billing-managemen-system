...
$sql= "SELECT * from  sales where delete_status='0' AND build_date='".date('Y-m-d')."'
ORDER BY id DESC";
...
<li class="breadcrumb-item"><a>Daily Sales Report</a>
</li>
<li class="breadcrumb-item"><a href="">Daily Sales Report</a>
</li>
</ul>
</div>
</div>

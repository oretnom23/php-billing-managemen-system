...
<li class="breadcrumb-item"><a>Groups</a>
</li>
...
<form role="form" action="editgroup2.php?id=<?php echo $_GET['id'];?>">
                                                ...
                                                <div class="form-group">
                                                        <label for="group_level">Select Group Level</label>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="radio">
                                                        <label>
                                                            <input type="radio" name="group_status"  value="0" <?php if($result['group_status']=='0'){echo "checked";}?>>Deactive
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>
                                                <div class="col-lg-12">
                                                        ...
                                                        <div class="form-group">
                                                           <center>     <button type="submit" class="btn btn-success" name="btn"> Submit</button> </center> </div>
                                                       </div>
                                                   </div>

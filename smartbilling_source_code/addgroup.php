...
<form role="form" method="post">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control"name="group_name" placeholder="Enter Groupname" required>
                                                    </div>
                                                    <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="radio">
                                                        <label>
                                                            <input type="radio" name="group_status"  value="1" checked>Active
                                                        </label>
                                                    </div>
                                                    <div class="radio">
                                                        <label>
                                                            <input type="radio" name="group_status"  value="0">Deactive
                                                        </label>

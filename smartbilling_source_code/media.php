  ...
  <tr>
   ...
   <img src="image/<?php echo $row3['file_name'];?>" style="width:125px;height:125px;"class="img-thumbnail" />
    ...
    <td>  
          ...
          <a href="deletemedia.php?id=<?php echo $row3['id']?>" onclick="return confirm('Are you sure to delete this record?')">  <input id="delete" type="submit" name="delete" value="Delete" class="btn btn-danger" /></a>
        </td>
          </tr>
<?php 
}
